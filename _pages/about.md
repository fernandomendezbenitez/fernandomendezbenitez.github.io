...
title: About
permalink: /
subtitle: <b> Finance | Stochastics | Computation </b> 
profile:
  align: right
...
- **Black-Karasinski Robust Parametrisation:** reading BK model parameters from scarce credit spread data, converting parameter uncertainty into a nonlinear-expectation filtering problem

- **Orders of Roughness:** quantifying the pricing and hedging cost of misspecifying the Hurst exponent against a smooth benchmark
